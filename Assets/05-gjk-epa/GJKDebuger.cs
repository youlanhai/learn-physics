...
namespace Sample05
{
    ...
    public class GJKDebuger : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (gjk.isCollision)
            {
                if (inputData.showEPAEdges)
                {
                    ...
                    {
                        lineTool.DrawLine(gjk.currentEpaEdge.a, gjk.currentEpaEdge.b, new Color(1, 0, 1, 1));
                    }
                }
                ...
                {
                    Transform t = inputData.colliderB.transform;
                    t.position = t.position + new Vector3(gjk.penetrationVector.x, gjk.penetrationVector.y, 0);
                }
            }
        ...
        void DrawSimplexEdges(SimplexEdge simplex, Color cr)
        {
            ...
            {
                edgePoints.Add(edges[i].a + edges[i].normal * 0.02f);
            }
